...
/**
 * Servlet implementation class AjaxEditOrder
 */
@WebServlet("/AjaxEditOrder")
public class AjaxEditOrder extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(account.getloadType().equals("editOrder")){
            ...
            responseData = editOrder.main(accountData);
