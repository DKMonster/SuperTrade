...
/**
 * Servlet implementation class AjaxClosePosition
 */
@WebServlet("/AjaxClosePosition")
public class AjaxClosePosition extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(account.getloadType().equals("closePositions")){
            ...
            try {
				responseData = closePosition.main(accountData);
