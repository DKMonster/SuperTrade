...
/**
 * Servlet implementation class AjaxOpenPositions
 */
@WebServlet("/AjaxOpenPositions")
public class AjaxOpenPositions extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(account.getloadType().equals("getOpenPositions")){
            ...
            listData = getOpenPositions.main(accountData);
