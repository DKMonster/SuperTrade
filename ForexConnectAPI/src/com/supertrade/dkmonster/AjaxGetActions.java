...
/**
 * Servlet implementation class AjaxGetActions
 */
@WebServlet("/AjaxGetActions")
public class AjaxGetActions extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(account.getloadType().equals("getActions")){
            ...
            listData = getActions.main(accountData);
