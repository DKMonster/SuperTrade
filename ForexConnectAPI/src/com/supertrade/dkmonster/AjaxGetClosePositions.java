...
/**
 * Servlet implementation class AjaxGetClosePositions
 */
@WebServlet("/AjaxGetClosePositions")
public class AjaxGetClosePositions extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(account.getloadType().equals("getClosePositions")){
            ...
            listData = getClosePositions.main(accountData);
