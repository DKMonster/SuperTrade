...
public class CPTableListener implements IO2GTableListener {

    private String mRequestID;
    private List<O2GTradeRow> mTrades;
    private CPOrderMonitor mOrderMonitor;
    private Semaphore mSemaphore;

    public CPTableListener(){
        mRequestID = "";
        mOrderMonitor = null;
    ...
    public void onAdded(String rowID, O2GRow rowData) {
        ...
        case ORDERS:
            ...
            if(mRequestID.equals(orderRow.getRequestID())) {
                if ((CPOrderMonitor.isClosingOrder(orderRow) || CPOrderMonitor.isOpeningOrder(orderRow)) &&
                        mOrderMonitor == null) {
                    ...
                    mOrderMonitor = new CPOrderMonitor(orderRow);
                }
            }
            break;
        case TRADES:
    ...
    private void printResult() {
        if (mOrderMonitor != null) {
            CPOrderMonitor.ExecutionResult result = mOrderMonitor.getResult();
